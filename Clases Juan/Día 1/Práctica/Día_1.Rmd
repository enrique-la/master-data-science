...
data1 <- read.csv('C:/Users/enriq/Desktop/Master/Data Science (MIB)/Clases Juan/Día 1/data/casos_tecnica_provincia.csv', 
                  header = T, sep = ',', stringsAsFactors = F,
                  check.names = F)

system.time(data1 <- read.csv('C:/Users/enriq/Desktop/Master/Data Science (MIB)/Clases Juan/Día 1/data/casos_tecnica_provincia.csv', 
                              header = T, sep = ',', stringsAsFactors = F,
                              check.names = F))
...
system.time(data1_copia <- data.table::fread("C:/Users/enriq/Desktop/Master/Data Science (MIB)/Clases Juan/Día 1/data/casos_tecnica_provincia.csv"))
class(data1_copia)
dim(data1_copia)
rm(data1_copia)
...
data2 <- read.csv('C:/Users/enriq/Desktop/Master/Data Science (MIB)/Clases Juan/Día 1/data/casos_tecnica_ccaa.csv',
                  header = T, sep = ',', stringsAsFactors = F,
                  check.names = F)

# Número de casos, hospitalizaciones y defunciones por fecha, edad y sexo
data3 <- data.table::fread('C:/Users/enriq/Desktop/Master/Data Science (MIB)/Clases Juan/Día 1/data/casos_hosp_uci_def_sexo_edad_provres.csv', 
                           header = T, sep = ',',
...
myData1 <- fromJSON('C:/Users/enriq/Desktop/Master/Data Science (MIB)/Clases Juan/Día 1/data/aeropuertos_2020.json')
output_dataframe1 <- as.data.frame(myData1$features)
data4 <- output_dataframe1$properties

myData2 <- fromJSON('C:/Users/enriq/Desktop/Master/Data Science (MIB)/Clases Juan/Día 1/data/airlines_delays.json',flatten = TRUE)
...
data6 = read.csv(file="C:/Users/enriq/Desktop/Master/Data Science (MIB)/Clases Juan/Día 1/data/student-mat.csv",sep = ";")
head(data6)
```
...
data5 %>%
  dplyr::count(Airport.Code,Time.Year) %>%
  head()
```
...
sum(flights$carrier %in% c('AA', 'UA', 'DL'))  
```
### ejercicio 1.4 #####
```{r}
head(flights)
sum(flights$month %in% c(7, 8, 9))
